    ...
    <div className={className}>
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div className="md:col-span-2">
          ...
          <input name="street_address" required defaultValue={defaults.street_address} className="form-input" />
        </div>
        <div className="md:col-span-2">
        ...
        <div>
          ...
          <input name="city" required defaultValue={defaults.city} className="form-input" />
        </div>
        <div>
